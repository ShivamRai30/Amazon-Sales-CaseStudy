...
select count(*) as count_of_null_values from amazon.sales 
where null;
#-------------------------------------------------------------------------------------------------------#
...
update amazon.sales set time_of_day =
case 
...
update amazon.sales set day_name =
(select  dayname(date));

alter table amazon.sales
add month_name varchar(10) not null;

update amazon.sales set month_name =
(select monthname(date)); 

select * from amazon.sales limit 10;
#-------------------------------------------------------------------------------------------------------#
...
select branch, sum(quantity) as Totalquantitysold from amazon_sales
group by branch
having Totalquantitysold > (select avg(quantity) from amazon_sales)
limit 1;
